    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex justify-center gap-4">
            <div class="bg-white/20 backdrop-blur-sm rounded-lg px-6 py-3 text-white">
                <div class="text-3xl font-bold"><?php echo e($blogs->total()); ?></div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredBlogs->count() > 0): ?>
            <div class="mb-16 relative">
                ...
                <div class="relative flex items-center justify-between mb-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredBlogs->count() > 1): ?>
                ...
                <div class="relative overflow-hidden rounded-2xl shadow-2xl ring-1 ring-black/5">
                    ...
                    <div id="carousel"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <!-- Slide -->
                            <div class="min-w-full carousel-slide relative">
                                <div
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featured->featured_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $featured->featured_image)); ?>"
                                        ...
                                        <div class="w-full lg:w-2/3 p-6 md:p-8 lg:p-12 space-y-3">
                                            ...
                                            <div class="inline-flex items-center gap-2 animate-fade-in">
                                                <span
                                                    ...
                                                    style="background-color: <?php echo e($featured->category->color); ?>;">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredBlogs->count() > 1): ?>
                                        <div
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <button
                                                    onclick="goToSlide(<?php echo e($index); ?>)"
                                                    class="slide-indicator transition-all duration-300 <?php echo e($loop->first ? 'w-8 h-2.5 bg-gradient-to-r from-indigo-500 to-purple-500' : 'w-2.5 h-2.5 bg-white/50'); ?> rounded-full hover:scale-110"
        ...
        <div class="mb-8">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                <a href="<?php echo e(route('blogs.index')); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium <?php echo e(!request('category') ? 'bg-indigo-600 text-white shadow-md' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'); ?> transition-all">
                    All Posts
                </a>
                           ...
                           class="relative block h-56 overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
                            ...
                            <?php else: ?>
                                <div
                                    ...
                                    <?php echo e(strtoupper(substr($blog->title, 0, 1))); ?>
                            ...
                            <div class="absolute bottom-3 left-3">
                                <span
                                    ...
                                    style="background-color: <?php echo e($blog->category->color); ?>">
                        ...
                        <div class="p-4 flex flex-col flex-grow bg-white">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm font-semibold text-gray-900"><?php echo e($blog->user->name); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($blog->published_at->format('M d, Y')); ?></p>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app-public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/usp/Laravel_Projects/usp_official/resources/views/blogs/index.blade.php ENDPATH**/ ?>