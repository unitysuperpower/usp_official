...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($messages->total()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($pendingCount); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($repliedCount); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($unreadCount); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <form method="GET" action="<?php echo e(route('admin.contact-messages.index')); ?>" class="flex flex-col md:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('admin.contact-messages.index')); ?>" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition">
                    Reset
                </a>
            </div>
        </form>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 <?php echo e($message->read_at ? '' : 'bg-blue-50'); ?>">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 font-medium"><?php echo e(Str::limit($message->subject, 50)); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($message->message, 80)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php
                                        $statusColors = [
                                    ...
                                    ?>
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($statusColors[$message->status]); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-xs text-gray-400"><?php echo e($message->created_at->format('h:i A')); ?></div>
                                </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\usp_official\resources\views\admin\contact-messages\index.blade.php ENDPATH**/ ?>