    ...
    <div class="fixed bottom-24 right-6 z-40 w-96 h-[32rem] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50" id="chatMessages" wire:poll.5s="loadMessages">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex <?php echo e($msg->is_admin ? 'justify-start' : 'justify-end'); ?>">
                    <div class="max-w-[70%]">
                        <div class="rounded-2xl px-4 py-2 <?php echo e($msg->is_admin ? 'bg-white text-gray-800 shadow' : 'bg-indigo-600 text-white'); ?>">
                            <p class="text-sm"><?php echo e($msg->message); ?></p>
                        </div>
                        <p class="text-xs text-gray-500 mt-1 <?php echo e($msg->is_admin ? 'text-left' : 'text-right'); ?>">
...
<?php /**PATH D:\usp_official\resources\views\livewire\chat\chat-box.blade.php ENDPATH**/ ?>