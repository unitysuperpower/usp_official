<?php $__env->startSection('title', 'Home - Transform Your Business'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="text-center lg:text-left space-y-6 lg:space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    <a href="<?php echo e(route('services.index')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold rounded-xl shadow-2xl transition transform hover:scale-105 duration-300">
                        <span>Explore Services</span>
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                        </svg>
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 border-2 border-white/30 hover:border-white/50 hover:bg-white/20 text-white font-bold rounded-xl backdrop-blur-sm transition duration-300">
...
<section id="categories" role="region" aria-labelledby="categories-heading" class="py-12 sm:py-16 lg:py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <a href="<?php echo e(route('services.index', ['category' => $category->slug])); ?>" class="group relative bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition duration-300 transform hover:-translate-y-2 overflow-hidden">
                <!-- Background Gradient -->
                ...
                <div class="relative z-10 flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 group-hover:text-indigo-600 transition"><?php echo e($category->name); ?></h3>
                    <p class="text-gray-600 text-sm leading-relaxed"><?php echo e($category->description); ?></p>
                    <div class="pt-3 inline-block px-4 py-1.5 bg-indigo-50 text-indigo-700 text-xs font-semibold rounded-full group-hover:bg-indigo-100 transition">
                        <?php echo e($category->services_count); ?> <?php echo e(Str::plural('Service', $category->services_count)); ?>
...
<section id="featured-services" role="region" aria-labelledby="featured-services-heading" class="py-12 sm:py-16 lg:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden">
                ...
                <div class="relative h-56 overflow-hidden bg-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->image): ?>
                        <img src="<?php echo e(Storage::url($service->image)); ?>" alt="<?php echo e($service->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                    <?php else: ?>
                ...
                <div class="p-6 lg:p-7 space-y-4">
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex-1">
                            <h3 class="text-xl font-bold text-gray-900 group-hover:text-indigo-600 transition mb-2"><?php echo e($service->title); ?></h3>
                            <p class="text-gray-600 text-sm line-clamp-2"><?php echo e($service->short_description); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-indigo-600">$<?php echo e(number_format($service->price, 2)); ?></p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->delivery_days): ?>
                            <div class="flex flex-col items-end text-right">
                                ...
                                <p class="text-lg font-semibold text-gray-900"><?php echo e($service->delivery_days); ?>d</p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <!-- CTA Button -->
                    <a href="<?php echo e(route('services.show', $service->slug)); ?>" class="w-full block py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl transition duration-300 transform hover:scale-105 text-center">
                        View Details
                    </a>
                </div>
            </div>
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('services.index')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white font-bold rounded-xl transition transform hover:scale-105 duration-300">
                View All Services
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                </svg>
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                <div class="flex items-start space-y-4">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($feature['title']); ?></h3>
...
<section class="py-12 sm:py-16 lg:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden">
            <div id="blog-container" class="flex gap-6 overflow-x-auto scroll-smooth pb-4" style="scrollbar-width: none; -ms-overflow-style: none;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latestBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>" class="flex-none w-80 group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
                        <!-- Image -->
                        <div class="relative h-48 overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->featured_image): ?>
                                <img src="<?php echo e(Storage::url($blog->featured_image)); ?>" alt="<?php echo e($blog->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                            <?php else: ?>
                                <div class="w-full h-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                                    <svg class="w-20 h-20 text-white opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('blogs.index')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg transition transform hover:scale-105">
...
<section class="py-16 sm:py-20 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('services.index')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white text-indigo-600 hover:bg-gray-100 font-bold rounded-xl shadow-2xl transition transform hover:scale-105">
                Explore Services
            </a>
            <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white/20 border-2 border-white hover:bg-white/30 text-white font-bold rounded-xl backdrop-blur-sm transition transform hover:scale-105">
                Contact Us
            </a>
        </div>
    </div>
...
<section class="py-16 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="<?php echo e(route('services.index')); ?>" class="inline-block bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition transform hover:scale-105">
...
<?php echo $__env->make('layouts.app-public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/usp/Laravel_Projects/usp_official/resources/views/home.blade.php ENDPATH**/ ?>