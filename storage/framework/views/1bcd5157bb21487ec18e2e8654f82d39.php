    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="original-message">
                <p><strong>Subject:</strong> <?php echo e($originalMessage->subject); ?></p>
                <p><strong>Message:</strong></p>
                <p><?php echo e($originalMessage->message); ?></p>
                <p><strong>Sent on:</strong> <?php echo e($originalMessage->created_at->format('F j, Y \a\t g:i A')); ?></p>
            </div>

            <h3>Our Reply:</h3>
            <div class="reply">
                <?php echo nl2br(e($replyContent)); ?>
...
</html><?php /**PATH /home/usp/Laravel_Projects/usp_official/resources/views/emails/contact-reply.blade.php ENDPATH**/ ?>