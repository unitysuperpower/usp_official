...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredBlogs->count() > 0): ?>
            <div class="mb-16">
                ...
                <div class="relative overflow-hidden rounded-2xl shadow-2xl">
                    <div id="carousel" class="flex transition-transform duration-700 ease-in-out">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="min-w-full flex-shrink-0 carousel-slide">
                                <div class="relative h-[280px] md:h-[420px] lg:h-[480px] bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden group">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featured->featured_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $featured->featured_image)); ?>" alt="<?php echo e($featured->title); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                                    ...
                                    <div class="absolute inset-0 flex items-center">
                                        <div class="w-full lg:w-2/3 p-6 md:p-8 lg:p-12 space-y-3">
                                            <div class="inline-flex items-center gap-2 flex-wrap">
                                                <span class="inline-block px-3 py-1.5 rounded-lg text-xs font-bold text-white shadow-lg backdrop-blur-sm" style="background-color: <?php echo e($featured->category->color); ?>">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featured->excerpt): ?>
                                                <p class="text-sm md:text-base text-white/90 line-clamp-2 max-w-2xl hidden md:block"><?php echo e($featured->excerpt); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex flex-wrap items-center gap-3 md:gap-4">
                                                <div class="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-3 py-1.5">
                                                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-xs shadow-lg">
                                                        <?php echo e(strtoupper(substr($featured->user->name, 0, 2))); ?>

                                                    </div>
                                                    <div>
                                                        <p class="text-white font-semibold text-xs"><?php echo e($featured->user->name); ?></p>
                                                        <p class="text-white/70 text-xs"><?php echo e($featured->published_at->format('M d, Y')); ?></p>
                                                    </div>
                                                </div>
                                                <div class="flex items-center gap-2 md:gap-3 text-white/90 text-xs bg-white/10 backdrop-blur-md rounded-full px-3 py-1.5">
                                                    <span class="flex items-center gap-1.5">
                                                        ...
                                                        <?php echo e(number_format($featured->views_count)); ?>
                                                    ...
                                                    <span class="flex items-center gap-1.5">
                                                        ...
                                                        <?php echo e(number_format($featured->likes_count)); ?>
                                                    ...
                                                    <span class="flex items-center gap-1.5">
                                                        ...
                                                        <?php echo e(number_format($featured->comments_count)); ?>
                                                    ...
                                                    <span class="hidden md:inline-flex items-center gap-1.5">
                                                        ...
                                                        <?php echo e(ceil(str_word_count($featured->content) / 200)); ?> min
                                                    </span>
                                                </div>
                                            </div>
                                            
                                            <a href="<?php echo e(route('blogs.show', $featured->slug)); ?>" class="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-gray-900 font-bold rounded-lg hover:bg-gray-50 hover:scale-105 transition-all shadow-xl text-sm">
                                                Read Article
                                    ...
                                    <?php if($featuredBlogs->count() > 1): ?>
                                        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2 bg-black/30 backdrop-blur-sm rounded-full px-3 py-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button onclick="goToSlide(<?php echo e($index); ?>)" class="slide-indicator transition-all duration-300 <?php echo e($loop->first ? 'w-8 h-2.5 bg-white' : 'w-2.5 h-2.5 bg-white/50 hover:bg-white/75'); ?> rounded-full" data-index="<?php echo e($index); ?>"></button>
        ...
        <div class="text-center mb-12">
            <div class="inline-block px-6 py-3 rounded-full text-white font-bold text-lg mb-4 shadow-lg" style="background-color: <?php echo e($category->color); ?>">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('blogs.index')); ?>" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                            All Posts
                        </a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('blogs.category', $cat->slug)); ?>" class="block px-4 py-2 rounded-lg <?php echo e($cat->id == $category->id ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100'); ?> transition">
                                <span class="inline-block w-3 h-3 rounded-full mr-2" style="background-color: <?php echo e($cat->color); ?>"></span>
                                <?php echo e($cat->name); ?>
            ...
            <div class="lg:col-span-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                                ...
                                <div class="p-6">
                                    <!-- Category Badge -->
                                    <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold text-white mb-3" style="background-color: <?php echo e($blog->category->color); ?>">
                                    ...
                                    <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span><?php echo e($blog->user->name); ?></span>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                        ...
                                        <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>" class="text-indigo-600 font-semibold hover:text-indigo-800 transition">
                                            Read More →
                                        </a>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                        ...
                        <a href="<?php echo e(route('blogs.index')); ?>" class="inline-block px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition">
                            Browse All Posts
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const totalSlides = <?php echo e($featuredBlogs->count()); ?>;
...
<?php echo $__env->make('layouts.app-public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\usp_official\resources\views\blogs\category.blade.php ENDPATH**/ ?>