...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ auth()->user()->serviceRequests()->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ auth()->user()->serviceRequests()->where('status', 'pending')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ auth()->user()->serviceRequests()->where('status', 'completed')->count() }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
        ...
        <div class="overflow-x-auto">
            @if(auth()->user()->serviceRequests()->count() > 0)
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach(auth()->user()->serviceRequests()->latest()->take(10)->get() as $request)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="text-sm font-semibold text-gray-900">{{ $request->service->title }}</div>
            ...
            @else
                <div class="py-16 text-center">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('services.index') }}" class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('services.index') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition group">
        ...
        <a href="{{ route('user.profile.edit') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition group">
            <div class="flex items-center space-x-4">
        ...
        <a href="{{ route('home') }}" class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition group">
            <div class="flex items-center space-x-4">
