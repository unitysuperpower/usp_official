    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-t-3xl shadow-xl p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                        ...
                        <p class="text-sm text-gray-600">
                            @if($conversation->assignedTo)
                                <span class="flex items-center gap-1">
                                    ...
                                    Chatting with {{ $conversation->assignedTo->name }}
                                </span>
                            @else
                                <span class="flex items-center gap-1">
                ...
                <a href="{{ route('home') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition text-sm font-medium">
                    Close Chat
                </a>
            </div>
        </div>
                    ...
                    @if($message->is_admin)
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 max-w-lg">
                                ...
                                <p class="text-xs text-gray-500 mt-1 ml-2">{{ $message->created_at->format('h:i A') }}</p>
                            </div>
                        </div>
                    @else
                        <!-- User Message -->
