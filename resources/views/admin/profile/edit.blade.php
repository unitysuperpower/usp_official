        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <form action="{{ route('admin.profile.password') }}" method="POST" class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="password" 
                                   ...
                                   required
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition @error('current_password') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="password" 
                                   name="password" 
                                   required
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition @error('password') border-red-500 @enderror">
                            @error('password')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2 border-b border-gray-100">
                            ...
                            <span class="text-sm font-semibold text-gray-900">{{ now()->diffForHumans() }}</span>
                        </div>
                ...
                <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg transition text-sm font-medium">
                            📊 Dashboard
                        </a>
                        <a href="{{ route('admin.chat.index') }}" class="block px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg transition text-sm font-medium">
                            💬 Live Chat
                        </a>
                        <a href="{{ route('admin.contact-messages.index') }}" class="block px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg transition text-sm font-medium">
                            📧 Messages
                        </a>
                    </div>
                </div>
