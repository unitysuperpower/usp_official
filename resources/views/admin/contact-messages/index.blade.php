        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $messages->total() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $repliedCount }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $unreadCount }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <form method="GET" action="{{ route('admin.contact-messages.index') }}" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.contact-messages.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition">
                    Reset
                </a>
            </div>
        </form>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($messages as $message)
                            <tr class="hover:bg-gray-50 {{ $message->read_at ? '' : 'bg-blue-50' }}">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 font-medium">{{ Str::limit($message->subject, 50) }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @endphp
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $statusColors[$message->status] }}">
